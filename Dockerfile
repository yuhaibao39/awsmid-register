...
ARG DEAULT_OPTS='-javaagent:/agent/skywalking-agent.jar -Dskywalking_config=/agent/config/agent.config -Dskywalking.agent.service_name=fengce-service-register -Dskywalking.collector.backend_service=18.212.19.251:11800'
