...
ARG DEAULT_OPTS='-javaagent:/agent/skywalking-agent.jar -Dskywalking_config=/agent/config/agent.config -Dskywalking.agent.service_name=awsmid-registry -Dskywalking.collector.backend_service=13.214.219.235:11800'
