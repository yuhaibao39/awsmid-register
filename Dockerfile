...
ARG DEAULT_OPTS='-javaagent:/agent/skywalking-agent.jar -Dskywalking_config=/agent/config/agent.config -Dskywalking.agent.service_name=awsmid-registry -Dskywalking.collector.backend_service=172.20.227.134:11800'
